function navbar(){
    return `
        <div id="navtop">
            <div id="mainlogo">
                <img class="mainlogo" src="https://assets.pharmeasy.in/web-assets/dist/fca22bc9.png" alt="1">
            </div>
            <div id="bar">
